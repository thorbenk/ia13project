...
if __name__ == "__main__":
	...
	for f in files:
		...
		label_ar[:,:,slice] = file2array(f)
	
	f2 = h5py.File(filename_out, 'w')
    	f2.create_dataset("volume/data", data=label_ar.astype(numpy.uint8))
    	f2.close()
